...
export type UnregisterMutationVariables = {
  id: Scalars['String'],
  email: Scalars['String']
};
...
export const UnregisterDocument = gql`
    mutation Unregister($id: String!, $email: String!) {
  unregister(id: $id, email: $email)
}
    `;
export type UnregisterMutationFn = ApolloReactCommon.MutationFunction<UnregisterMutation, UnregisterMutationVariables>;
 ...
 * });
 */
export function useUnregisterMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UnregisterMutation, UnregisterMutationVariables>) {
        return ApolloReactHooks.useMutation<UnregisterMutation, UnregisterMutationVariables>(UnregisterDocument, baseOptions);
      }
export type UnregisterMutationHookResult = ReturnType<typeof useUnregisterMutation>;
export type UnregisterMutationResult = ApolloReactCommon.MutationResult<UnregisterMutation>;
export type UnregisterMutationOptions = ApolloReactCommon.BaseMutationOptions<UnregisterMutation, UnregisterMutationVariables>;
